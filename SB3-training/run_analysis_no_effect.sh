...
python $PROJECT_DIR/sb3_waterworld_vector.py --n_pursuers 2 --haptic_modulation_type no_effect --haptic_weight 0.5 --policy_name MlpLstmPolicy >> $PROJECT_DIR/output_no_effect.txt
echo "...done."
