...
python $PROJECT_DIR/sb3_waterworld_vector.py --n_pursuers 2 --haptic_modulation_type average --haptic_weight 0.3 --policy_name MlpLstmPolicy >> output_average_haptic_weight0.3.txt
echo "...done."
