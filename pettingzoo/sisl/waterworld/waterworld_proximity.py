...
from pettingzoo.sisl.waterworld.waterworld_base_proximity import FPS
from pettingzoo.sisl.waterworld.waterworld_base_proximity import WaterworldBase as _env
